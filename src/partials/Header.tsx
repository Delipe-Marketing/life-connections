    ...
    <header className="absolute left-0 top-0 z-10 w-full px-4 py-4">
      <div className="mx-auto flex max-w-7xl flex-col gap-3">
        ...
        <div className="hidden md:flex items-center justify-between rounded-full bg-white/10 px-16 py-3 shadow-xl backdrop-blur-md">
          ...
          >
            <Icon icon="mdi:whatsapp" className="h-6 w-6 shrink-0 text-[#C0E850]" />
            <span className="text-[15px] font-normal tracking-wide">0800 333 4321</span>
          </a>
          <div className="flex items-center gap-5">
            <a href="https://www.instagram.com/lifeconnections_br/" target="_blank" rel="noopener noreferrer"
              className="text-white transition hover:text-[#C0E850]" aria-label="Instagram">
            ...
            <a href="https://www.facebook.com/lifeconnectionsbr" target="_blank" rel="noopener noreferrer"
              className="text-white transition hover:text-[#C0E850]" aria-label="Facebook">
        ...
        <div className="flex items-center justify-between rounded-full bg-white/10 px-5 py-3 shadow-xl backdrop-blur-md md:gap-8 md:px-16 md:py-4">
          ...
          >
            <Icon icon={menuAberto ? "mdi:close" : "mdi:menu"} className="h-7 w-7" />
          </button>
        </div>
        ...
        {menuAberto && (
          <div className="flex flex-col gap-1 rounded-2xl bg-black/90 px-5 py-5 shadow-2xl backdrop-blur-md md:hidden">
            ...
            {/* PDF */}
            <a href="/PDF/contrato.pdf" target="_blank" rel="noopener noreferrer"
              onClick={() => setMenuAberto(false)}
